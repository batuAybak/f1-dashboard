...
teamsRouter.route('/') // Display all teams
    .get(async (req, res) => {
        const allTeams = await getAllTeams()
        res.send(allTeams)
    })

teamsRouter.param('id', async (req, res, next, id) => { //Parameter validation
...
teamsRouter.route('/:id') // Display team by id
    .get(async (req, res) => {
        res.send(req.team)
    })

teamsRouter.route('/:id/drivers') // Display drivers by team id
    .get(async (req, res) => {
